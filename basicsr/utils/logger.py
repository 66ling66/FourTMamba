...
def init_wandb_logger(opt):
    ...
    import wandb
    logger = logging.getLogger('basicsr-mamba')
...
def get_root_logger(logger_name='basicsr-mamba', log_level=logging.INFO, log_file=None):
    """Get the root logger.
    ...
    Args:
        logger_name (str): root logger name. Default: 'basicsr-mamba'.
